...
if(isset($_POST['Deactivate'])){
    ...
    //update the files
    $contents = file_get_contents(".\../textfiles/pupils.txt");
    $line = "$usercode deactivated .\../textfiles/assignments/$usercode.txt .\../textfiles/assignments/$usercode.txt";
    $contents = str_replace($line, "$usercode activated .\../textfiles/assignments/$usercode.txt .\../textfiles/assignments/$usercode.txt", $contents);
    file_put_contents(".\../textfiles/pupils.txt", $contents);
    //also remove the usercode from the request list
    $contents1 = file_get_contents(".\../c/activation/requests.txt");
    $line1 = "$usercode";
    $contents1 = str_replace($line1,"",$contents);
